...
$string['pluginname_help'] = 'Это специфический формат OpenTest XML 2.0 для импорта и экспорта вопросов. Плагин построен на основе базового плагина импорта/экпорта Moodle XML. Плагин работает в тестовом режиме, по вопросам выявленных ошибок обращайтесь <a href="ctdl-staff@nure.ua">ctdl-staff@nure.ua</a>';
